        ...
        <div className="container-custom max-w-4xl px-4 text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-12">
            <div className="card bg-gray-800 border-2 border-gray-700 p-4">
              ...
              <h3 className="text-xs font-bold text-white mb-1" style={{textTransform: 'none'}}>Sopralluogo</h3>
            ...
            <div className="card bg-gray-800 border-2 border-gray-700 p-4">
              ...
              <h3 className="text-xs font-bold text-white mb-1" style={{textTransform: 'none'}}>Progettazione</h3>
              <p className="text-[10px] text-gray-400 font-medium leading-tight">
                Setup su misura
              </p>
            </div>
            <div className="card bg-gray-800 border-2 border-gray-700 p-4">
              ...
              <h3 className="text-xs font-bold text-white mb-1" style={{textTransform: 'none'}}>Installazione</h3>
              <p className="text-[10px] text-gray-400 font-medium leading-tight">
                Montaggio e test
              </p>
            </div>
