      ...
      >
        <nav className="container-custom" aria-label="Navigazione principale">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2 md:gap-3 ml-auto lg:ml-6 mr-4 lg:mr-0">
              <a
                href="tel:+393462122933"
                className="text-gray-300 hover:text-accent transition-colors p-1.5 md:p-2"
                aria-label="Telefono"
              >
              ...
              <a
                ...
                className="text-gray-300 hover:text-accent transition-colors p-1.5 md:p-2 hidden sm:block"
                aria-label="Email"
              >
                <svg className="w-4 h-4 md:w-5 md:h-5" fill="currentColor" viewBox="0 0 24 24">
